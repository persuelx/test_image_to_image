...
if __name__ == '__main__':
    # labelme_path = "jiao_file/"
    labelme_path = "json_data/"
    saved_coco_path = "./"
    # 创建文件
    ...
    for file in train_path:
        # print(file.replace("json","json"),"%scoco/images/train2017/"%saved_coco_path)
        shutil.copy(file.replace(".json",".png"),"%scoco/images/train2017/"%saved_coco_path)
